...
@section('page-content')
    <form class="layui-form" action=""> 
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"
                       ...
                       placeholder="未设置支付密码"
                       class="layui-input"
                       value="{{ $result->pay_password ?? '' }}">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">提款地址</label>
            <div class="layui-input-block">
                <input type="text"
                       name="wallet_address"
                       autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="yqr" autocomplete="off" placeholder="" class="layui-input" value="{{$result->yqr}}">
            </div>
        </div>
        

        <div class="layui-form-item">
            <label class="layui-form-label">交割合约控制</label>
            <div class="layui-input-block">
