...
@section('page-content')
 <form class="layui-form layui-form-pane layui-inline" action="">
    ...
    <div class="layui-inline">
     ...
     <div class="layui-inline">
         <div class="layui-input-inline">
             <input type="text" placeholder="注册时间范围" id="reg_time" autocomplete="off" class="layui-input">
         </div>
     </div>
    ...
    <div class="layui-inline" style="margin-left: 10px">
     ...
     <button class="layui-btn layui-btn-danger" id="today_user">今日注册</button>
    <button class="layui-btn layui-btn-normal layui-btn-radius" id="add_user_info">添加新用户</button>
</form>
...
<script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="score">信用分</a>
    ...
    layui.use(['element', 'form', 'layer', 'table','laydate'], function () {
        ...
        var user_table = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'phone', title:'手机号', minWidth:150, hide: true}
                ,{field:'userreal_name', title:'真实姓名', minWidth:120}
                ,{field:'level_text', title:'用户等级', minWidth:110}
                ,{field:'balance', title:'余额', minWidth:110}
                ,{field:'score', title:'信用分', minWidth:100}
                ,{field:'account_number', title:'交易账号', minWidth:150}
                ,{field:'common', title:'备注', minWidth:150, hide: true}
           ...
           //     ,{field:'card_id', title: '身份证号',minWidth: 180, hide: true}
                ...
                ,{field: 'risk_name', title: '交割合约控制', minWidth: 90}
                ,{field: 'status', title: '状态', minWidth: 80, templet:"#status_t"}
                ,{field: 'password', title: '登录密码', minWidth: 90}
           //   ,{field: 'cash_info', title: '银行卡', minWidth: 80, templet:"#cash_info"}
            //    ,{field: 'cash_info_international', title: '钱包地址', minWidth: 80, templet:"#cash_info_international"}
              ...
              //  ,{field:'is_bind_box_author', title:'开通盲盒作者', minWidth:120, templet: '#bind_box', hide: true}
                 ,{field:'is_trader', title:'交易员', minWidth:120, templet: '#is_trader'}
                 ,{field:'time', title:'注册时间', minWidth:150}
                 ,{field:'last_login_time', title:'最后登录时间', minWidth:150}
        ...
        laydate.render({
            elem: '#reg_time',
            type: 'date',
            range: true  // 开启范围选择，格式：2025-12-01 - 2025-12-07
        });

        // 今日注册按钮
        $('#today_user').click(function () {
        ...
        form.on('submit(mobile_search)', function(data){
            ...
            // 取注册时间范围
            var timeRange = $('#reg_time').val(); // 形如：2025-12-01 - 2025-12-07
